...
-   `name`: This is the name of the Volume by which it will be
...
Here\'s an example of pod configuration using the `emptyDir`
Volume:
...
-   `""` (an empty string): This is the default value implying
